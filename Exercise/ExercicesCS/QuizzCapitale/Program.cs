        ...
        static void Main(string[] args)
        {
            ...
            while (continuer) 
            {
                ...
                while (rejouer)
                {
                    ...
                    Console.WriteLine("\nRejouer dans le même mode de jeu ? o/n : ");
                    string reponseRejouer = Console.ReadLine().Trim().ToLower();
                    rejouer = (reponseRejouer == "o");


                    if (!rejouer)
                    {
                        Console.WriteLine("Retourner au menu principal ? o/n :");
                        string reponseMenu = Console.ReadLine().Trim().ToLower();
                        continuer = (reponseMenu == "o");
                        break;
